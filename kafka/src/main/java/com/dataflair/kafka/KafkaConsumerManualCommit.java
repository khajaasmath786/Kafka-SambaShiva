...
public class KafkaConsumerManualCommit {
	...
	public KafkaConsumerManualCommit(String zookeeper, String groupName, String topicName) {
	...
	public void run(int numThreads) {
		...
		for (final KafkaStream stream : streams) {
			...
			executor.submit(new ConsumerInstanceManualCommit(stream, threadNumber,consumer));
			threadNumber++;
		}
	}
	...
	private static ConsumerConfig createConsumerConfiguration(
		...
		// Set the auto commit offset false
